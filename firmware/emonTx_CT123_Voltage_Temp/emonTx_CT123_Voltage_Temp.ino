...
{
  Serial.begin(9600);
  Serial.println("Peter emonTX CT123 Voltage example");
  ...
  ct1.voltageTX(253.8, 1.7);                                         // ct.voltageTX(calibration, phase_shift) - make sure to select correct calibration for AC-AC adapter  http://openenergymonitor.org/emon/modules/emontx/firmware/calibration. Default is set for Ideal Power voltage adapter. 
